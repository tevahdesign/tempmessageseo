      ...
      <div className="min-h-screen flex flex-col bg-app-dark">
        ...
        <div className="max-w-lg mx-auto w-full">
          <div className="p-4 bg-app-darker rounded-lg mt-8 shadow-md">
            <h1 className="text-2xl font-bold text-white mb-4">Temp Message - Deutsch</h1>
            <p className="text-gray-300">
              Willkommen bei der deutschen Version von Temp Message. Unser temporärer E-Mail-Service bietet
              Einweg-E-Mail-Adressen zum Schutz Ihrer Online-Privatsphäre.
            </p>
          </div>
          <EmailInfo />
          <EmailGenerator />
